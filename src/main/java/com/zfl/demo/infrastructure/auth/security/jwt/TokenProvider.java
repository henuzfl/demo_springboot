package com.zfl.demo.infrastructure.auth.security.jwt;
...
public class TokenProvider implements InitializingBean {
    ...
    public Authentication getAuthentication(String token) {
        ...
        if (null != claims.get(AUTHORITIES_KEY) && StringUtils.isNotBlank(claims.get(AUTHORITIES_KEY).toString())) {
            authorities = Arrays.stream(claims.get(AUTHORITIES_KEY).toString().split(",")).map(SimpleGrantedAuthority::new).collect(Collectors.toList());
        }
